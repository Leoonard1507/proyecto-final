      ...
      {modalOpen && selectedScore && (
        ...
        >
          ...
          >
            ...
            {/* Movie title and score info */}
            <div className="flex flex-col flex-1 overflow-auto">
              <h4 className="text-2xl font-bold mb-4">{selectedScore.movie_title}</h4>
              <p className="text-yellow-400 font-bold text-4xl mb-6">
                {selectedScore.puntuacion}⭐
              </p>
              <p className="text-xs text-gray-400 mt-auto self-end">
                {new Date(selectedScore.created_at).toLocaleDateString("es-ES", {
                  day: "2-digit",
                  month: "2-digit",
                  year: "numeric",
                })}{" "}
                {new Date(selectedScore.created_at).toLocaleTimeString("es-ES", {
                  hour: "2-digit",
                  minute: "2-digit",
                })}
              </p>
