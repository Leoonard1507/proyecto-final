    ...
    <div className="mt-3">
      ...
      <div className="grid grid-cols-1 gap-4">
        {scores.slice().reverse().map((score) => {
          const lineBreaks = score.comentario?.split("\n").length ?? 0;
          const showButton = lineBreaks > 2;
            ...
            >
              ...
              <div className="flex flex-col justify-between flex-1 pl-4 min-w-0">
                <div className="mr-6">
                  ...
                  {score.comentario && (
                    <p className="mt-2 text-sm text-gray-300 break-words w-full line-clamp-3 overflow-hidden">
                      {score.comentario}
                    </p>
                  )}
                </div>
